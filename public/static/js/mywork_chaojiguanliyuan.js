  $(function (){
	$("#myModal,#mytuijianren,#mychakan,#mybianji,#myshenhe,#mytongzhi,#mytequan,#myfenghao,#mychongzhi").modal({backdrop:"static",show:false});//禁止点击空白处关闭弹框
    // 日期插件
...
function  ajaxs(){
            ...
            success:function(data){
               ...
               if(data.errorCode==0){
                ...
                $("#chakan").click(function(){
                    ...
                    $("#pbImage").before("<div class='users'><label>姓名 :<span id='name'></span></label>&nbsp;&nbsp;&nbsp;&nbsp;<label>"+$(".cardss").html()+"<span id='identity'></span></label></div>"); 
    ...
    $(".bianji").unbind("click").click(function(){
        ...
        $(".bianji_hyzh").val(bianji_username)
        $(".beizhu").hide();
        $(".bianji_beizhu").val('');
        $(".bzs textarea").val("");
        $(".bzs").hide();
